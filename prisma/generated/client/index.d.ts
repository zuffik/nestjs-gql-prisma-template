...
export namespace Prisma {
  ...
  > {
     ...
     **/
    findUnique<
      T extends TestFindUniqueArgs<ExtArgs>,
    ...
    > extends True
      ? Prisma__TestClient<
          $Types.GetResult<TestPayload<ExtArgs>, T, 'findUnique', never>,
          never,
          ExtArgs
        >
      : Prisma__TestClient<
          $Types.GetResult<TestPayload<ExtArgs>, T, 'findUnique', never> | null,
          null,
          ExtArgs
        >;
    ...
    findUniqueOrThrow<T extends TestFindUniqueOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'findUniqueOrThrow', never>,
      never,
      ExtArgs
    >;
     ...
     **/
    findFirst<
      T extends TestFindFirstArgs<ExtArgs>,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? Prisma__TestClient<
          $Types.GetResult<TestPayload<ExtArgs>, T, 'findFirst', never>,
          never,
          ExtArgs
        >
      : Prisma__TestClient<
          $Types.GetResult<TestPayload<ExtArgs>, T, 'findFirst', never> | null,
          null,
          ExtArgs
        >;
    ...
    findFirstOrThrow<T extends TestFindFirstOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'findFirstOrThrow', never>,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends TestFindManyArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'findMany', never>
    >;
    ...
    create<T extends TestCreateArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'create', never>,
      never,
      ExtArgs
    >;
    ...
    delete<T extends TestDeleteArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'delete', never>,
      never,
      ExtArgs
    >;
    ...
    update<T extends TestUpdateArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'update', never>,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends TestUpsertArgs<ExtArgs>>(
      ...
      $Types.GetResult<TestPayload<ExtArgs>, T, 'upsert', never>,
      never,
      ExtArgs
    >;
   ...
   * Test findUnique
   */
  export interface TestFindUniqueArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  > extends TestFindUniqueArgsBase<ExtArgs> {
    /**
   ...
   * Test findFirst
   */
  export interface TestFindFirstArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  > extends TestFindFirstArgsBase<ExtArgs> {
    /**
     * Throw an Error if query returns no results
